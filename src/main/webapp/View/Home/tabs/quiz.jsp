                        ...
                        <div class="form-group form-inline">
                            ...
                            <form ng-if="question.type === 'M/C'">
                                <div ng-repeat="choice in question.choices">
                                    ...
                                    <button type="button" ng-if="question.choices.length === 1 && question.choices.indexOf(choice) === 0" id="addRemoveChoiceBtn{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoiceBtn','' + $parent.$index + question.choices.indexOf(choices),question,choice)">+</button>
                                    <button type="button" ng-if="question.choices.length > 1 && (question.choices.indexOf(choice) >= 0 && question.choices.indexOf(choice) < question.choices.length - 1)" id="addRemoveChoiceBtn{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoiceBtn','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                    <button type="button" ng-if="question.choices.length > 1 && question.choices.length < 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoiceBtn{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoiceBtn','' + $parent.$index + question.choices.indexOf(choices),question,choice)">+</button>
                                    <button type="button" ng-if="question.choices.length > 1 && question.choices.length < 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoiceBtn1{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoiceBtn1','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                    <button type="button" ng-if="question.choices.length > 1 && question.choices.length === 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoiceBtn{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoiceBtn','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                </div>
                        ...
                        <div class="questionDiv">
                            <div ng-repeat="question in quiz.edit.questionList">
                                ...
                                <div class="form-group form-inline">
                                    ...
                                    <form ng-if="question.type === 'M/C'">
                                        <div ng-repeat="choice in question.choices">
                                            <input type="radio" name="choices" id="mcRadioButton{{$parent.$index}}{{question.choices.indexOf(choice)}}" ng-checked="choice.isChecked" ng-click="setMCAnswer(question,choice)" value="{{question.choices.indexOf(choice)+1|character}}">{{question.choices.indexOf(choice)+1|character}}
                                            <input type="text" id="multipleChoice{{$parent.$index}}{{question.choices.indexOf(choices)}}" ng-model="choice.answerChoice" class="form-control">
                                            <button type="button" ng-if="question.choices.length === 1 && question.choices.indexOf(choice) === 0" id="addRemoveChoice{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoice','' + $parent.$index + question.choices.indexOf(choices),question,choice)">+</button>
                                            <button type="button" ng-if="question.choices.length > 1 && (question.choices.indexOf(choice) >= 0 && question.choices.indexOf(choice) < question.choices.length - 1)" id="addRemoveChoice{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoice','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                            <button type="button" ng-if="question.choices.length > 1 && question.choices.length < 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoice{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoice','' + $parent.$index + question.choices.indexOf(choices),question,choice)">+</button>
                                            <button type="button" ng-if="question.choices.length > 1 && question.choices.length < 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoice1{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoice1','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                            <button type="button" ng-if="question.choices.length > 1 && question.choices.length === 5 && (question.choices.indexOf(choice) === question.choices.length - 1)" id="addRemoveChoice{{$parent.$index}}{{question.choices.indexOf(choices)}}" class="btn btn-default" ng-click="addRemoveChoice('addRemoveChoice','' + $parent.$index + question.choices.indexOf(choices),question,choice)">-</button>
                                        </div>
                                        <label>Answer is: {{question.answer.answerChoice}}</label>
                                    </form>
