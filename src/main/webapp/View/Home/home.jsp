...
<div class="content container-fluid app-wrapper row">
    ...
    <div class="coursePane" ng-controller="courseCtrl">
       <div class="col-md-2">
    ...
    <div class="col-md-10">
        ...
        <div class="col-md-4 forumPane" ng-controller="forumCtrl">
            <div class="panel panel-default">
                <fieldset class="panel-group" id="accordion">
                                ...
                                <small>
                                    ...
                                    <span class="col-md-3">
                                        <span class="likes-sect col-md-6">
                                            <span ng-class="post.liked > 0 ? 'liked' : 'not-liked'" ng-click="updateLike(post)" class="likes-icon col-md-6 btn-small btn glyphicon glyphicon-thumbs-up"></span>
